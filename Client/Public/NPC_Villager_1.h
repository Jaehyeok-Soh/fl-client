...
class CNPC_Villager_1 final : public CNPC_Base
{
	using Super = CNPC_Base;

private:
	CNPC_Villager_1(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CNPC_Villager_1(const CNPC_Villager_1& rhs);
	virtual ~CNPC_Villager_1() = default;
...
public:
	static CNPC_Villager_1* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
