...
class CMonster_Boomer_Body final : public CMonster_Body_Base
{
	using Super = CMonster_Body_Base;
private:
	CMonster_Boomer_Body(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	CMonster_Boomer_Body(const CMonster_Boomer_Body& rhs);
	virtual ~CMonster_Boomer_Body() = default;
...
public:
	static CMonster_Boomer_Body* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
