...
class CMonster_Fly final : public CMonster_Base
{
	using Super = CMonster_Base;
private:
	CMonster_Fly(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CMonster_Fly(const CMonster_Fly& rhs);
...
public:
	static CMonster_Fly* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
