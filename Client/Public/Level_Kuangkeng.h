...
class CLevel_Kuangkeng : public CLevel_Client
{
	using Super = CLevel_Client;
private:
	explicit CLevel_Kuangkeng(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	virtual ~CLevel_Kuangkeng() = default;
...
public:
	static CLevel_Kuangkeng* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
