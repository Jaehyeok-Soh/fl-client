...
void CDialogueManager::Ready_Dialogue()
{
	...
	// 주점 진입, 퀘스트 수주
	{
		CreateNode(100, -1, 101, L"카밀라", L"빈민촌 분위기가 흉흉해. 도와줄 용병이 필요하다더군.");
	...
	// 빈민촌 진입, 퀘스트 수주
	{
		CreateNode(102, -1, 103, L"아이 엄마", L"제발 우리 아이 좀 찾아주세요! 빈민촌 구석으로 갔는데 안 보여요.");
		CreateNode(103, 102, -1, L"은비", L"금방 찾아올 테니 너무 걱정 마십시오");

		CreateNode(104, -1, -1, L"아이", L"흑흑... 괴물 소리가 나서 숨어 있었어요...");

		CreateNode(105, -1, 106, L"아이 엄마", L"정말 감사합니다! 약소하지만 보상입니다. 참, 갱도 쪽에서 이상한 놈들이 수군거리는 걸 봤어요.");
