...
HRESULT CUILoading_Text::Attach_Personal_Info()
{
	...
	case DTO::EUITextSubClassType::LOADING_TEXT_TITLE:
		...
		m_vecTitleText.push_back(L"°­º´ÁØ");
		m_vecTitleText.push_back(L"¼ÒÀçÇõ");
		m_vecTitleText.push_back(L"ÃÖÁ¤¿ì");
		m_vecTitleText.push_back(L"¹Î°ÇÈñ");
		m_vecTitleText.push_back(L"±èÀººñ");
		m_vecTitleText.push_back(L"¹é½Â¹Î");
		break;
	case DTO::EUITextSubClassType::LOADING_TEXT_CONTENTS:
		m_vecContentsText.reserve(10);
		m_vecContentsText.push_back(L"ÆÀÀå / ÇÁ·¹ÀÓ¿öÅ©");
		m_vecContentsText.push_back(L"¼Ò¹æ°ü / ÇÇÁ÷½º");
		m_vecContentsText.push_back(L"ÀÌÆåÆ®");
		m_vecContentsText.push_back(L"¸Ê");
		m_vecContentsText.push_back(L"ÇÃ·¹ÀÌ¾î");
