...
HRESULT CBuilder_UI::Register_Class(DTO::EUIClassType eClassType, const DTO::TUI_GenericUIData& data, CCanvas* pCanvas)
{
	...
	if (eClassType == DTO::EUIClassType::PROGRESS_BAR)
	{
		...
		if (isPlayerStat)
		{
			...
			wstrProtoTag = L"Prototype_UI_PlayerStatProgress";
		}
		else if (isLoading)
		{
	...
	else if (eClassType == DTO::EUIClassType::UI_TEXT)
	{
		...
		if (isPlayerStat)
		{
			...
			wstrProtoTag = L"Prototype_UI_PlayerStatText";
		...
		else if (isMenu)
		{
			...
			wstrProtoTag = L"Prototype_UI_MenuText";
		}
		else if (isLoading)
		{
	...
	else if (eClassType == DTO::EUIClassType::TRIGGER)
	{
		...
		if (isMenu)
		{
			...
			wstrProtoTag = L"Prototype_UI_UIMenuTrigger";
	...
	else if (eClassType == DTO::EUIClassType::DYNAMIC_IMAGE)
	{
		...
		if (isPlayerSkill)
		{
			...
			wstrProtoTag = L"Prototype_UI_SkillBG";
		}
		else if (isMiniMap)
		{
			...
			wstrProtoTag = L"Prototype_UI_MiniMap";
		}
		else if (isHoverIcon)
		{
			...
			wstrProtoTag = L"Prototype_UI_HoverImage";
		}
		else if (isMenu)
		{
			...
			wstrProtoTag = L"Prototype_UI_MenuImage";
		}
		else if (isOutLine)
		{
			...
			wstrProtoTag = L"Prototype_UI_MenuOutline";
		}
		else if (isLoading)
		{
			...
			wstrProtoTag = L"Prototype_UI_LoadingImage";
		}
		else if (isMonsterNameplate)
		{
