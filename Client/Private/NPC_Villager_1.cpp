...
CNPC_Villager_1::CNPC_Villager_1(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: Super(pDevice, pDeviceContext)
{
}

CNPC_Villager_1::CNPC_Villager_1(const CNPC_Villager_1& rhs)
	: Super(rhs)
{
}

HRESULT CNPC_Villager_1::Initialize_Prototype()
{
	if (FAILED(Super::Initialize_Prototype()))
		return E_FAIL;

	Set_Object_Enum_Tag(OBJECT_ENUM_TAG::NPC_VILLAGER_1);

	return S_OK;
}

HRESULT CNPC_Villager_1::Initialize(void* pArg)
{
...
HRESULT CNPC_Villager_1::Awake(const _uint iCurrentLevelID)
{
...
void CNPC_Villager_1::Update_Priority(const _float fTimeDelta)
{
	Super::Update_Priority(fTimeDelta);
}

void CNPC_Villager_1::Update(const _float fTimeDelta)
{
	Super::Update(fTimeDelta);
}

void CNPC_Villager_1::Update_Late(const _float fTimeDelta)
{
	Super::Update_Late(fTimeDelta);
}

void CNPC_Villager_1::Ready_Before_Render(const _float fTimeDelta)
{
	Super::Ready_Before_Render(fTimeDelta);
}

HRESULT CNPC_Villager_1::Render()
{
...
void CNPC_Villager_1::OnCollision(_uint iMyColliderLayer, _uint iOtherLayer, CGameObject* pOther)
{
	Super::OnCollision(iMyColliderLayer, iOtherLayer, pOther);
}

void CNPC_Villager_1::OnCollision_Enter(_uint iMyColliderLayer, _uint iOtherLayer, CGameObject* pOther, const COL_HIT_INFO& tHitInfo)
{
	Super::OnCollision_Enter(iMyColliderLayer, iOtherLayer, pOther, tHitInfo);
}

void CNPC_Villager_1::OnCollision_Exit(_uint iMyColliderLayer, _uint iOtherLayer, CGameObject* pOther)
{
	Super::OnCollision_Exit(iMyColliderLayer, iOtherLayer, pOther);
}

void CNPC_Villager_1::OnTrigger_Enter(_uint iMyColliderLayer, _uint iOtherLayer, CGameObject* pOther, const COL_HIT_INFO& tHitInfo)
{
	Super::OnTrigger_Enter(iMyColliderLayer, iOtherLayer, pOther, tHitInfo);
}

void CNPC_Villager_1::OnTrigger_Exit(_uint iMyColliderLayer, _uint iOtherLayer, CGameObject* pOther)
{
	Super::OnTrigger_Exit(iMyColliderLayer, iOtherLayer, pOther);
}

_bool CNPC_Villager_1::On_Hit(const HIT_DESC& hitDesc)
{
	return true;
}

void CNPC_Villager_1::Try_Attack(const HIT_DESC& hitDesc)
{
}

HRESULT CNPC_Villager_1::Ready_PartObjects()
{
	return S_OK;
}

HRESULT CNPC_Villager_1::Ready_Components(void* pArg)
{
...
CNPC_Base::NPC_DESC CNPC_Villager_1::Get_PreSetDesc(_uint iLevelId)
{
	...
	npcDesc.wstrNPCStateTag = g_wszNPC_Villager_1_State_Tag;
...
void CNPC_Villager_1::QuestEnter()
{
	Super::QuestEnter();
}
...
CNPC_Villager_1* CNPC_Villager_1::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CNPC_Villager_1* pInsatnce = new CNPC_Villager_1(pDevice, pDeviceContext);
	if (FAILED(pInsatnce->Initialize_Prototype()))
	{
		MSG_BOX("CNPC_Villager_1::Create, Failed");
...
CGameObject* CNPC_Villager_1::Clone(void* pArg)
{
	CNPC_Villager_1* pClone = new CNPC_Villager_1(*this);
	if (FAILED(pClone->Initialize(pArg)))
	{
		MSG_BOX("CNPC_Villager_1::Clone, Failed");
		Safe_Release(pClone);
	}
	return pClone;
}

void CNPC_Villager_1::Free()
{
	Super::Free();
}
