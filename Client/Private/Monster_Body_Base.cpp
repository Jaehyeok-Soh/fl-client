...
void CMonster_Body_Base::OnCollision(_uint iMyColliderLayer, CGameObject* pOther)
{
	Get_Parent()->OnCollision(iMyColliderLayer, pOther);
}

void CMonster_Body_Base::OnCollision_Enter(_uint iMyColliderLayer, CGameObject* pOther)
{
	Get_Parent()->OnCollision_Enter(iMyColliderLayer, pOther);
}

void CMonster_Body_Base::OnCollision_Exit(_uint iMyColliderLayer, CGameObject* pOther)
{
	Get_Parent()->OnCollision_Exit(iMyColliderLayer, pOther);
}

void CMonster_Body_Base::OnTrigger_Enter(_uint iMyColliderLayer, CGameObject* pOther)
{
	Get_Parent()->OnTrigger_Enter(iMyColliderLayer, pOther);
}

void CMonster_Body_Base::OnTrigger_Exit(_uint iMyColliderLayer, CGameObject* pOther)
{
