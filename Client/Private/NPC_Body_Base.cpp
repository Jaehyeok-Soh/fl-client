...
CNPC_Body_Base::CNPC_Body_Base(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: Super(pDevice, pDeviceContext)
{
}

CNPC_Body_Base::CNPC_Body_Base(const CNPC_Body_Base& rhs)
	: Super(rhs)
{
}

HRESULT CNPC_Body_Base::Initialize_Prototype()
{
...
HRESULT CNPC_Body_Base::Initialize(void* pArg)
{
...
HRESULT CNPC_Body_Base::Awake(const _uint iCurrentLevelIndex)
{
...
void CNPC_Body_Base::Update_Priority(_float fTimeDelta)
{
...
void CNPC_Body_Base::Update(_float fTimeDelta)
{
...
void CNPC_Body_Base::Ready_Before_Render(_float fTimeDelta)
{
...
void CNPC_Body_Base::OnCollision(_uint iMyColliderLayer, _uint iOtherLayer, CGameObject* pOther)
{
	Get_Parent()->OnCollision(iMyColliderLayer, iOtherLayer, pOther);
}

void CNPC_Body_Base::OnCollision_Enter(_uint iMyColliderLayer, _uint iOtherLayer, CGameObject* pOther, const COL_HIT_INFO& tHitInfo)
{
	Get_Parent()->OnCollision_Enter(iMyColliderLayer, iOtherLayer, pOther, tHitInfo);
}

void CNPC_Body_Base::OnCollision_Exit(_uint iMyColliderLayer, _uint iOtherLayer, CGameObject* pOther)
{
	Get_Parent()->OnCollision_Exit(iMyColliderLayer, iOtherLayer, pOther);
}

void CNPC_Body_Base::OnTrigger_Enter(_uint iMyColliderLayer, _uint iOtherLayer, CGameObject* pOther, const COL_HIT_INFO& tHitInfo)
{
	Get_Parent()->OnTrigger_Enter(iMyColliderLayer, iOtherLayer, pOther, tHitInfo);
}

void CNPC_Body_Base::OnTrigger_Exit(_uint iMyColliderLayer, _uint iOtherLayer, CGameObject* pOther)
{
	Get_Parent()->OnTrigger_Exit(iMyColliderLayer, iOtherLayer, pOther);
}

_bool CNPC_Body_Base::On_Hit(const HIT_DESC& hitDesc)
{
	return true;
}

HRESULT CNPC_Body_Base::Render()
{
...
CBone* CNPC_Body_Base::Get_Bone(CNPC_Body_Base::EBone eBone)
{
...
const Matrix* CNPC_Body_Base::Get_SocketMatrix(const _char* szBoneName)
{
...
const Matrix* CNPC_Body_Base::Get_SocketMatrix(_uint iIndex)
{
...
HRESULT CNPC_Body_Base::Ready_Components(NPCBODY_DESC* pDesc)
{
...
HRESULT CNPC_Body_Base::Bind_ShaderResources()
{
	return S_OK;
}

HRESULT CNPC_Body_Base::Ready_ComputeShader()
{
...
HRESULT CNPC_Body_Base::Ready_Bones(NPCBODY_DESC* pDesc)
{
