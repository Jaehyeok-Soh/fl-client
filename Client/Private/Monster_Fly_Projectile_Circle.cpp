...
CMonster_Fly_Projectile_Circle::CMonster_Fly_Projectile_Circle(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: Super(pDevice, pDeviceContext)
{
}

CMonster_Fly_Projectile_Circle::CMonster_Fly_Projectile_Circle(const CMonster_Fly_Projectile_Circle& rhs)
	: Super(rhs)
{
}

HRESULT CMonster_Fly_Projectile_Circle::Initialize_Prototype()
{
...
HRESULT CMonster_Fly_Projectile_Circle::Initialize(void* pArg)
{
...
CMonster_Fly_Projectile_Circle* CMonster_Fly_Projectile_Circle::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CMonster_Fly_Projectile_Circle* pInstance = new CMonster_Fly_Projectile_Circle(pDevice, pDeviceContext);
	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("CMonster_Fly_Projectile_Circle::Create, Failed");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CMonster_Fly_Projectile_Circle::Clone(void* pArg)
{
	CMonster_Fly_Projectile_Circle* pInstance = new CMonster_Fly_Projectile_Circle(*this);
	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("CMonster_Fly_Projectile_Circle::Clone, Failed");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CMonster_Fly_Projectile_Circle::Free()
{
	Super::Free();
}
