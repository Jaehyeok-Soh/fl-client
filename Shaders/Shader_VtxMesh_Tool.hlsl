...
PS_OUT_DEFFERED PS_SELECT(PS_IN_MESH input)
{
    PS_OUT_DEFFERED output = (PS_OUT_DEFFERED)0;
...
PS_OUT_DEFFERED PS_PREVIEW(PS_IN_MESH input)
{
    PS_OUT_DEFFERED output = (PS_OUT_DEFFERED) 0;
...
technique11 T0
{
	...
	PASS_RS_DS_BS_VP(P1, RS_Default_CullNone, DS_Default, BS_Default, VS_MAIN, PS_SELECT)
	PASS_RS_DS_BS_VP(P2, RS_Default_CullNone, DS_Default, BS_Default, VS_MAIN, PS_PREVIEW)
};