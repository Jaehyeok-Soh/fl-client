...
HRESULT CVIBuffer_Rect_NorTex::Initialize_Prototype(void* pArg)
{
...
CVIBuffer_Rect_NorTex* CVIBuffer_Rect_NorTex::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, void* pArg)
{
    CVIBuffer_Rect_NorTex* pInstance = new CVIBuffer_Rect_NorTex(pDevice, pDeviceContext);
    if (FAILED(pInstance->Initialize_Prototype(pArg)))
    {
        MSG_BOX("CVIBuffer_Rect_NorTex::Create, Failed");
...
CComponent* CVIBuffer_Rect_NorTex::Clone(void* pArg)
{
    ...
    {
        MSG_BOX("CVIBuffer_Rect_NorTex::Create, Clone");
        Safe_Release(pInstance);
    }
    return pInstance;
}
