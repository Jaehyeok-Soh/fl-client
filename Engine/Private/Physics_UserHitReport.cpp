...
void CPhysics_UserHitReport::onShapeHit(const PxControllerShapeHit& hit)
{
...
void CPhysics_UserHitReport::onControllerHit(const PxControllersHit& hit)
{
...
CPhysics_UserHitReport::CPhysics_UserHitReport()
{
}

HRESULT CPhysics_UserHitReport::Initialize()
{
...
CGameObject* CPhysics_UserHitReport::Conversion_GameObject(void* userData)
{
	return static_cast<CGameObject*>(userData);
}

CPhysics_UserHitReport::GAMEOBJECTINFO CPhysics_UserHitReport::Get_GameObject(void* leftArgs, void* rightArgs)
{
...
void CPhysics_UserHitReport::Ready_EventCallChain()
{
}

#ifdef _DEBUG
void CPhysics_UserHitReport::Debug_Log(HITEVENT::Enum event, GAMEOBJECTINFO& info)
{
...
CPhysics_UserHitReport* CPhysics_UserHitReport::Create()
{
	CPhysics_UserHitReport* pInstance = new CPhysics_UserHitReport();

	if (FAILED(pInstance->Initialize()))
	{
		MSG_BOX("Failed to Created : CPhysics_UserHitReport");
...
void CPhysics_UserHitReport::Free()
{
	Super::Free();
}
