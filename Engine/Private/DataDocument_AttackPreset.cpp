...
CDataDocument_AttackPreset::CDataDocument_AttackPreset()
{
}

HRESULT CDataDocument_AttackPreset::Initialize()
{
	return S_OK;
}
...
HRESULT CDataDocument_AttackPreset::FromJson(const json& j)
{
	Clear();
...
HRESULT CDataDocument_AttackPreset::Try_Add(const DTO::TAttackPreset_Data& data)
{
	IObjectDataBase* pObjectBase = Create_ObjectData();
	static_cast<CDataStruct_AttackPreset*>(pObjectBase)->Get_Data() = data;
	return Try_Add(pObjectBase);
}

IObjectDataBase* CDataDocument_AttackPreset::Create_ObjectData()
{
	return CDataStruct_AttackPreset::Create();
}

HRESULT CDataDocument_AttackPreset::Try_Add(IObjectDataBase* pObject)
{
	if (pObject == nullptr)
		return E_FAIL;
...
CDataDocument_AttackPreset* CDataDocument_AttackPreset::Create()
{
	CDataDocument_AttackPreset* pInstance = new CDataDocument_AttackPreset();
	if (FAILED(pInstance->Initialize()))
	{
		MSG_BOX("CDataDocument_AttackPreset::Create, Failed");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CDataDocument_AttackPreset::Free()
{
	Super::Free();
}
