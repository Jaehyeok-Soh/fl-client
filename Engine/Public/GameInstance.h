...
#pragma region FONT_MANAGER
	...
	HRESULT Draw_Text(const _wstring& strFontTag, const _tchar* pText, const Vec2& vPosition, Vec4 vColor = Vec4(1.f, 1.f, 1.f, 1.f), const _float fRotate = 0.f, const Vec2 & vOrigin = Vec2{ 0.f, 0.f }, const _float fScale = 1.f);
#pragma endregion
