...
namespace Engine
{
	...
	enum class DEFFERRED { DEBUG, DIRECTIONAL, POINT, OUTLINE, SSAO_GEN, SSAO_BLURH, SSAO_BLURV, COMBINED, BLOOM_EXTRACT, BLOOM_BLURH, BLOOM_BLURV, TONEMAP, WBOIT, END };
...
#pragma endregion
	...
	typedef struct EObjectEnumTag
	{
		enum Enum
		{
			...
			OBJECT_INTERACT_CHANGELEVEL = 2502,
	...
	public:
		static Enum		ToEnum(const string& strType)
		{
			...
			if (strType == "OBJECT_INTERACT_CHANGELEVEL") return OBJECT_ENUM_TAG::OBJECT_INTERACT_CHANGELEVEL;
		...
		static string	ToString(Enum eType)
		{
			...
			case OBJECT_ENUM_TAG::OBJECT_INTERACT_CHANGELEVEL:				return "OBJECT_INTERACT_CHANGELEVEL";
	...
	inline static const OBJECT_ENUM_TAG::Enum g_arrAllObjectTags[] = {
		...
		OBJECT_ENUM_TAG::OBJECT_INTERACT_CHANGELEVEL,
...
#pragma region NETWORK
	struct PACKET_ID
	{
		enum Enum : UINT16
		{
			...
			ROOM_JOIN_NOTIFY = 231,
			ROOM_LEAVE_NOTIFY = 232,

			// UDP
			CHARACTER_SYNC = 1001,
			CHARACTER_SYNC_BROADCAST = 1002,
		};
	};
