...
public:
	...
	void	Update_AdditiveAnimatoin(const vector<class CBone*>& vecBones, CComputeShader* pAnimAdditiveCS, CComputeShader* pPreAnimCS, const _float fTimeDelta, _uint iTotalBoneNum, _uint iRefFirstKeyFrame);
