...
enum class EUITextSubClassType
{
	...
	//동그란 미니게임
	MINIGAME_CIRCLE_BEGIN,
	MINIGAME_CIRCLE_TIMER_TEXT,
	MINIGAME_CIRCLE_CLEAR_TEXT,
...
NLOHMANN_JSON_SERIALIZE_ENUM(EUITextSubClassType,
	{
		...
		{ EUITextSubClassType::MINIGAME_CIRCLE_TIMER_TEXT,			"MINIGAME_CIRCLE_TIMER_TEXT" },
		{ EUITextSubClassType::MINIGAME_CIRCLE_CLEAR_TEXT,			"MINIGAME_CIRCLE_CLEAR_TEXT" },
	...
	inline EUITextSubClassType StringToUITextSubClassType(const std::string& str)
{
	...
	else if (str == "MINIGAME_CIRCLE_TIMER_TEXT")				return EUITextSubClassType::MINIGAME_CIRCLE_TIMER_TEXT;
...
inline std::string UITextSubClassTypeToString(EUITextSubClassType e)
{
	...
	case EUITextSubClassType::MINIGAME_CIRCLE_TIMER_TEXT:			return "MINIGAME_CIRCLE_TIMER_TEXT";
...
enum class EUIDImageSubClassType
{
	...
	MINIGAME_CIRCLE_BEGIN,
	MINIGAME_CIRCLE_BG,
	MINIGAME_CIRCLE_INNER_BG,
	MINIGAME_CIRCLE_TIMER_BG,
	MINIGAME_CIRCLE_TIMER_CIRCLE,
	MINIGAME_CIRCLE_POINT,
	MINIGAME_CIRCLE_POINT_BG,
	MINIGAME_CIRCLE_POINT_FX,
	MINIGAME_CIRCLE_CLEAR_POINT,
	MINIGAME_CIRCLE_CLEAR_POINT_BG,
	MINIGAME_CIRCLE_CLEAR_POINT_BG_S,
	MINIGAME_CIRCLE_CLEAR_POINT_FX,
	MINIGAME_CIRCLE_CURSOR,
	MINIGAME_CIRCLE_KEY_ICON,
	MINIGAME_CIRCLE_SPACE_ICON,
...
NLOHMANN_JSON_SERIALIZE_ENUM(EUIDImageSubClassType,
	...
	{ EUIDImageSubClassType::MINIGAME_CIRCLE_BEGIN,						"MINIGAME_CIRCLE_BEGIN" },
	{ EUIDImageSubClassType::MINIGAME_CIRCLE_BG,						"MINIGAME_CIRCLE_BG" },
	{ EUIDImageSubClassType::MINIGAME_CIRCLE_INNER_BG,					"MINIGAME_CIRCLE_INNER_BG" },
	{ EUIDImageSubClassType::MINIGAME_CIRCLE_TIMER_BG,					"MINIGAME_CIRCLE_TIMER_BG" },
	{ EUIDImageSubClassType::MINIGAME_CIRCLE_TIMER_CIRCLE,				"MINIGAME_CIRCLE_TIMER_CIRCLE" },
	{ EUIDImageSubClassType::MINIGAME_CIRCLE_POINT,						"MINIGAME_CIRCLE_POINT" },
	{ EUIDImageSubClassType::MINIGAME_CIRCLE_POINT_BG,					"MINIGAME_CIRCLE_POINT_BG" },
	{ EUIDImageSubClassType::MINIGAME_CIRCLE_POINT_FX,					"MINIGAME_CIRCLE_POINT_FX" },
	{ EUIDImageSubClassType::MINIGAME_CIRCLE_CLEAR_POINT,				"MINIGAME_CIRCLE_CLEAR_POINT" },
	{ EUIDImageSubClassType::MINIGAME_CIRCLE_CLEAR_POINT_BG,			"MINIGAME_CIRCLE_CLEAR_POINT_BG" },
	{ EUIDImageSubClassType::MINIGAME_CIRCLE_CLEAR_POINT_BG_S,			"MINIGAME_CIRCLE_CLEAR_POINT_BG_S" },
	{ EUIDImageSubClassType::MINIGAME_CIRCLE_CLEAR_POINT_FX,			"MINIGAME_CIRCLE_CLEAR_POINT_FX" },
	{ EUIDImageSubClassType::MINIGAME_CIRCLE_CURSOR,					"MINIGAME_CIRCLE_CURSOR" },
	{ EUIDImageSubClassType::MINIGAME_CIRCLE_KEY_ICON,					"MINIGAME_CIRCLE_KEY_ICON" },
	...
	inline EUIDImageSubClassType StringToUIDImageSubType(const std::string& str)
{
	...
	if (str == "MINIGAME_CIRCLE_BEGIN")					return EUIDImageSubClassType::MINIGAME_CIRCLE_BEGIN;
	if (str == "MINIGAME_CIRCLE_BG")					return EUIDImageSubClassType::MINIGAME_CIRCLE_BG;
	if (str == "MINIGAME_CIRCLE_INNER_BG")				return EUIDImageSubClassType::MINIGAME_CIRCLE_INNER_BG;
	if (str == "MINIGAME_CIRCLE_TIMER_BG")				return EUIDImageSubClassType::MINIGAME_CIRCLE_TIMER_BG;
	if (str == "MINIGAME_CIRCLE_TIMER_CIRCLE")			return EUIDImageSubClassType::MINIGAME_CIRCLE_TIMER_CIRCLE;
	if (str == "MINIGAME_CIRCLE_POINT")					return EUIDImageSubClassType::MINIGAME_CIRCLE_POINT;
	if (str == "MINIGAME_CIRCLE_POINT_BG")				return EUIDImageSubClassType::MINIGAME_CIRCLE_POINT_BG;
	if (str == "MINIGAME_CIRCLE_POINT_FX")				return EUIDImageSubClassType::MINIGAME_CIRCLE_POINT_FX;
	if (str == "MINIGAME_CIRCLE_CLEAR_POINT")			return EUIDImageSubClassType::MINIGAME_CIRCLE_CLEAR_POINT;
	if (str == "MINIGAME_CIRCLE_CLEAR_POINT_BG")		return EUIDImageSubClassType::MINIGAME_CIRCLE_CLEAR_POINT_BG;
	if (str == "MINIGAME_CIRCLE_CLEAR_POINT_BG_S")		return EUIDImageSubClassType::MINIGAME_CIRCLE_CLEAR_POINT_BG_S;
	if (str == "MINIGAME_CIRCLE_CLEAR_POINT_FX")		return EUIDImageSubClassType::MINIGAME_CIRCLE_CLEAR_POINT_FX;
	if (str == "MINIGAME_CIRCLE_CURSOR")				return EUIDImageSubClassType::MINIGAME_CIRCLE_CURSOR;
	if (str == "MINIGAME_CIRCLE_KEY_ICON")				return EUIDImageSubClassType::MINIGAME_CIRCLE_KEY_ICON;
...
inline const char* UIDImageSubTypeToString(EUIDImageSubClassType type)
{
	...
	case EUIDImageSubClassType::MINIGAME_CIRCLE_BEGIN:					return "MINIGAME_CIRCLE_BEGIN";
	case EUIDImageSubClassType::MINIGAME_CIRCLE_BG:						return "MINIGAME_CIRCLE_BG";
	case EUIDImageSubClassType::MINIGAME_CIRCLE_INNER_BG:				return "MINIGAME_CIRCLE_INNER_BG";
	case EUIDImageSubClassType::MINIGAME_CIRCLE_TIMER_BG:				return "MINIGAME_CIRCLE_TIMER_BG";
	case EUIDImageSubClassType::MINIGAME_CIRCLE_TIMER_CIRCLE:			return "MINIGAME_CIRCLE_TIMER_CIRCLE";
	case EUIDImageSubClassType::MINIGAME_CIRCLE_POINT:					return "MINIGAME_CIRCLE_POINT";
	case EUIDImageSubClassType::MINIGAME_CIRCLE_POINT_BG:				return "MINIGAME_CIRCLE_POINT_BG";
	case EUIDImageSubClassType::MINIGAME_CIRCLE_POINT_FX:				return "MINIGAME_CIRCLE_POINT_FX";
	case EUIDImageSubClassType::MINIGAME_CIRCLE_CLEAR_POINT:			return "MINIGAME_CIRCLE_CLEAR_POINT";
	case EUIDImageSubClassType::MINIGAME_CIRCLE_CLEAR_POINT_BG:			return "MINIGAME_CIRCLE_CLEAR_POINT_BG";
	case EUIDImageSubClassType::MINIGAME_CIRCLE_CLEAR_POINT_BG_S:		return "MINIGAME_CIRCLE_CLEAR_POINT_BG_S";
	case EUIDImageSubClassType::MINIGAME_CIRCLE_CLEAR_POINT_FX:			return "MINIGAME_CIRCLE_CLEAR_POINT_FX";
	case EUIDImageSubClassType::MINIGAME_CIRCLE_CURSOR:					return "MINIGAME_CIRCLE_CURSOR";
	case EUIDImageSubClassType::MINIGAME_CIRCLE_KEY_ICON:				return "MINIGAME_CIRCLE_KEY_ICON";
