...
public:
	...
	_float Get_BaseFov() const { return m_fBaseFov; }
	void Set_BaseFov(_float fFov) { m_fBaseFov = fFov; Update_Proj(m_fBaseFov); }
	_float Get_RenderFov() const { return m_fRenderFov; }
