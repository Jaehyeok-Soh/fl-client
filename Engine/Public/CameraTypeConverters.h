...
inline Vec3 ToVec3(const Float3& v)
{
    return Vec3(v.x, v.y, v.z);
}

inline  CAMERA_SHAKE_DESC           ToRuntimeDesc(const CAMERA_SHAKE_DATA& data)
{
...
inline CAMERA_FOV_DESC             ToRuntimeDesc(const CAMERA_FOV_DATA& data)
{
...
inline CAMERA_POSITION_OFFSET_DESC ToRuntimeDesc(const CAMERA_POSITION_OFFSET_DATA& data)
{
...
inline CAMERA_ROTATION_OFFSET_DESC ToRuntimeDesc(const CAMERA_ROTATION_OFFSET_DATA& data)
{
